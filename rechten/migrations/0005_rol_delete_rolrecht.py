...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('rechten', '0004_rolrecht_recht_alter_rolrecht_naam'),
    ]
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('naam', models.CharField(max_length=100, verbose_name='rol')),
                ...
                ('attribuut', models.ManyToManyField(blank=True, related_name='rollen', to='rechten.verwerkingattribuut')),
            ],
            options={
