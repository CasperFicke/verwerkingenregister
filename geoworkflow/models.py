...
class Straat(models.Model):
  ...
  # relaties
  gemeente = models.ForeignKey('gemeente', on_delete=models.CASCADE, related_name='gemeenten')
  # functie om model in de admin web-pagina te kunnen presenteren
  def __str__(self):
    return f'{self.naam}'
...
class Baggebeurtenis(models.Model):
  ...
  # relaties
  bagobjecttype = models.ForeignKey('bagobjecttype', blank=True, null=True, on_delete=models.CASCADE, related_name='bagobjecttypen')
  # functie om model in de admin web-pagina te kunnen presenteren
  def __str__(self):
    return f'{self.naam}'
